<template>
  <div class="vue-model-window" v-show="visibleMain">
    <div
      class="main"
      :class="{ active: active }"
      :style="modalStyle"
    ...
    >
      <div
        ...
        @mousedown.stop.prevent="onDraggableDown"
      >
        ...
        <div class="head-buttons">
          ...
          <div
            class="head-button quit-button"
            @click.stop.prevent="onClickQuitButton"
          >
            <div>
              <svg viewBox="0 0 7 7">
                <path d="M0 0 L 7 7 M 0 7 L 7 0" />
              </svg>
            </div>
          </div>
        </div>
      ...
      <div class="resizable-elements" v-if="resizable">
        <div
          class="resizable"
          :class="name"
          :key="name"
          @mousedown.stop.prevent="onResizableDown(name)"
          v-for="name in [
            'top-left',
            'top-right',
            'bottom-left',
    ...
    if (this.recordRect || this.recordVisibility) {
      ...
      if (vmodalDataDict && vmodalDataDict[this.id]) {
        ...
        if (
          ...
          Object.prototype.hasOwnProperty.call(vmodalData, "visible")
        ) {
...
.main {
  ...
  border-radius: 4px;
  border: solid rgb(199, 198, 200) 1px;
  cursor: default;
  ...
  .title {
    ...
    .head-buttons {
      ...
      .maximize-button {
        background-color: rgb(39, 203, 66);
        border-color: rgb(43, 172, 45);
        div {
          width: 7px;
          height: 7px;
